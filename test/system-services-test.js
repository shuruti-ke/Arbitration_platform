...
(async () => {
  ...
  const certValidation = await certValidator.validateCertificate({
    id: 'test-cert-001',
    issuer: 'Test CA',
    subject: 'Test Subject'
  });
  console.log('Certificate validation result:', certValidation);
  ...
  console.error('System services test failed:', error);
  process.exitCode = 1;
});
